...
// toBeTruthy
test('Should be truthy', () => {
    expect(functions.checkValue('hello')).not.toBeFalsy()
})
...
// Array content
test('marc should be in usernames', () => {
    usernames = ['john', 'marc', 'lise'];
    expect(usernames).toContain('marc')
})
